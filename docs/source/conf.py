# -*- coding: utf-8 -*-
#
# html2text documentation build configuration file, created by
...
htmlhelp_basename = 'html2textdoc'
...
latex_documents = [
  ('index', 'html2text.tex', u'html2text Documentation',
...
man_pages = [
    ('index', 'html2text', u'html2text Documentation',
...
texinfo_documents = [
  ('index', 'html2text', u'html2text Documentation',
   u'Alexander Artemenko', 'html2text', 'Converts HTML text into the Markdown.',
   'Miscellaneous'),
]
